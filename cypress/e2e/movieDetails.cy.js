describe('Movie Details UI', () => {
  beforeEach(() => {
    ...
    cy.get("div").contains("h3", "Black Adam").click()
    ...
    it('Should load all movie posters and allow user to click and display more details', () => {
      cy.get("div").contains("h2", "Black Adam")
        .get("div").contains("h3", "The world needed a hero. It got Black Adam.")
    ...
    it('Should allow user to return to main page and click on another movie to display details', () => {
      cy.get("button").contains("Back to Movies").click()
      ...
      cy.get("div").contains("h3", "Black Panther: Wakanda Forever").click()
      cy.wait('@getMovieDetailsAgain')
      cy.get("div").contains("h2", "Black Panther: Wakanda Forever")
        .get("div").contains("h3", "Forever.")
